...
export default class MapBuilder {
  constructor(level, tileset, spriteSheet) {
    ...
    this.mountainSheet.src = new URL('../assets/sprites/mountain.png', import.meta.url).href;
    this.cloudsSheet = new Image();
    this.cloudsSheet.src = new URL('../assets/sprites/clouds.png', import.meta.url).href;
    this.castleSheet = new Image();
    this.castleSheet.src = new URL('../assets/sprites/castle.png', import.meta.url).href;
    ...
    this.sceneryEntities.push(
      new Scenery.Flagpole(this.tileset, level.flagpole[0], level.flagpole[1], level.flagpole[2], level.flagpole[3]),
    );

    // Castle
    this.sceneryEntities.push(
      new Scenery.Castle(this.castleSheet, level.castle[0], level.castle[1], level.castle[2], level.castle[3]),
    );
  }
