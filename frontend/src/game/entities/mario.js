...
export default class Mario extends Entity {
  constructor(img, xPos, yPos, width, height) {
    ...
    const self = this;
    this.jumpSound = new Audio(new URL('../assets/audio/sounds/jump.wav', import.meta.url).href);
    this.deathSound = new Audio(new URL('../assets/audio/sounds/mario_death.wav', import.meta.url).href);
    this.bumpSound = new Audio(new URL('../assets/audio/sounds/bump.wav', import.meta.url).href);
    this.powerupSound = new Audio(new URL('../assets/audio/sounds/powerup.wav', import.meta.url).href);
    this.powerdownSound = new Audio(new URL('../assets/audio/sounds/powerdown.wav', import.meta.url).href);
